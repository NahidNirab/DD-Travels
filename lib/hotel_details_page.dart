...
class HotelDet extends StatefulWidget {
  static const String routeName = '/hotel_detai';
  ...
  @override
  State<HotelDet> createState() => _HotelDetState();
}
                        ...
                        return Container(
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                var data = hotelList!.rooms![index];
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: CachedNetworkImage(
                                            imageUrl:
                                                "https://ddtravels.safafirm.com/${data.image}",
                                            width: double.infinity,
                                            height: 250,
                                            fit: BoxFit.cover,
